            ...
            if (ok) {
                ...
                (() => {
                    if (patients.length > 0) {
                        ...
                        return of(studies.map(attrs => attrs['0020000D'].Value[0]));
                    }
                })().subscribe(
                    studies => {
                        (() => {
                            ...
                            if (studies.length > 0 && series.length > 0) {
                                ...
                                return forkJoin(
                                    studies.map(study => {
                                        return this.service.getSeries(study, [],
                                            this.studyWebService.selectedWebService
                                        ).pipe(map(
                                            value => {
                                ...
                                return of(series.map(attrs => attrs['0020000E'].Value[0]));
                            }
                        })().subscribe(
                            series => {
                                studies = [];
                                ...
                                if (studies.length > 0) {
                                    ...
                                    objects = instances.map(attrs => attrs['00080018'].Value[0]);
                                    url += '?level=instance';
                                }
